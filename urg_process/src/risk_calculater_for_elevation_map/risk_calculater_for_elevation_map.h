...
/*
	各種パラメータ
*/
const float CALCULATE_TIME_STEP = 0.02;	// 何秒刻みの評価をするのか
...
const float DENGER_ANGLE = 0.25;  // 走れない角度
...
*/
class RiskCalculater : public ElevationMap
{
	public:
		...
		void returnCalculatedVehicleState(geometry_msgs::PoseArray *out);
